...
@Composable
fun ManageOtherAccounts(
  backOnClick: () -> Unit = {},
  userOnClick: (String) -> Unit = {},
) {
  val viewModel: ManageOtherAccountsViewModel = hiltViewModel()
...
@Composable
private fun ManageOtherAccounts(
  uiState: ManageOtherAccountsUiState = ManageOtherAccountsUiState(),
  backOnClick: () -> Unit = {},
  userOnClick: (String) -> Unit = {},
) {
  ...
  Crossfade(
    ...
    label = "ManageOtherAccounts Crossfade"
  ) {
    when (it) {
        ...
        Scaffold(
          ...
          topBar = {
            CenterAlignedTopAppBar(title = {
              Text(text = "All accounts in system")
            },
