...
@Composable
fun AccountSettingsChangePasswordNew(
  navigationButtonOnClick: () -> Unit = {},
) {
  val viewModel: AccountSettingsChangePasswordNewViewModel = hiltViewModel()
...
@Composable
private fun AccountSettingsChangePasswordNew(
  uiState: AccountSettingsChangePasswordNewUiState = AccountSettingsChangePasswordNewUiState(),
  navigationButtonOnClick: () -> Unit = {},
...
@Composable
private fun AccountSettingsChangePasswordNewPreview(
