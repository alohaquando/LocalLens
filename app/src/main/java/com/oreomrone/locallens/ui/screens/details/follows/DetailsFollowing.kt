...
@Composable
fun DetailsFollowing(
  backOnClick: () -> Unit = {},
  userOnClick: (String) -> Unit = {},
) {
  val viewModel: DetailsFollowingViewModel = hiltViewModel()
...
@Composable
private fun DetailsFollowing(
  uiState: DetailsFollowingUiState = DetailsFollowingUiState(),
  backOnClick: () -> Unit = {},
  userOnClick: (String) -> Unit = {},
) {
  ...
  Crossfade(
    ...
    label = "DetailsFollowing Crossfade"
  ) {
    when (it) {
...
@Composable
private fun DetailsFollowingPreview(

) {
  LocalLensTheme {
    DetailsFollowing(
      DetailsFollowingUiState(
        following = listOf(
